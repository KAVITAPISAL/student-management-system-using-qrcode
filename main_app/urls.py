...
urlpatterns = [
    ...
    path('search/',librarian_views.search),
    path('sort/',librarian_views.sort),
    path('addbook/',librarian_views.addbook),
    path('deletebook/<int:bookID>/',librarian_views.deletebook),
    path('request-book-issue/<int:bookID>/',librarian_views.issuerequest),
    path('my-issues/',librarian_views.myissues),
    path('my-fines/',librarian_views.myfines),
    path('payfines/<int:fineID>/',librarian_views.payfine),
    path('paystatus/<int:fineID>/',librarian_views.pay_status),
    path('all-issues/',librarian_views.requestedissues),
    path('all-fines/',librarian_views.allfines),
    path('issuebook/<int:issueID>/',librarian_views.issue_book),
    path('returnbook/<int:issueID>/',librarian_views.return_book),
    path('delete-fine/<int:fineID>/',librarian_views.deletefine),
