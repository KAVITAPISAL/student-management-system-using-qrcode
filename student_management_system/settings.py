...
EMAIL_HOST_USER = "kavitapisal2312@gmail.com"   #by which email id you want to send the mail
EMAIL_HOST_PASSWORD = "KavitaPisal@2312"  #password
...
RAZORPAY_KEY_ID=os.getenv("wertyuiop")
RAZORPAY_KEY_SECRET=os.getenv("asdfghjk")
